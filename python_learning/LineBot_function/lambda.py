...
def handle_message(event):
    # add to dynamodb
    table = boto3.resource('dynamodb', region_name='ap-northeast-3', aws_access_key_id=ACCESS_KEY, aws_secret_access_key=SECRET_KEY).Table('Rain_selene')
    Item = {
        'ID': uuid4().hex, 'timestamp': str(event.timestamp), 
